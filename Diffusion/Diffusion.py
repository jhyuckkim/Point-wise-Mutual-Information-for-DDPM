...
class GaussianDiffusionSampler(nn.Module):
    ...
    def p_mean_variance(self, x_t, t, get_eps=False):
    ...
    def forward(self, x_T, get_x_hat_list=False):
        """
        Algorithm 2.
        """
        x_t = x_T
        ...
        for time_step in reversed(range(self.T)):
            ...
            if get_x_hat_list:
                mean, var, eps = self.p_mean_variance(x_t=x_t, t=t, get_eps=True)
        ...
        x_0 = x_t
        return (torch.clip(x_0, -1, 1), x_hat_tensor, self.snr) if get_x_hat_list else torch.clip(x_0, -1, 1)
